...
// -------------- Tabela Jogos -----------------------------------------
    ...
    addJogos: function(obj, callback){  
        return db.query("INSERT INTO jogos (liga,equipeA, equipeB, diaJogo,oddsA,oddsB) VALUES (?,?,?,?,?,?);",[obj.liga,obj.equipeA, obj.equipeB,obj.diaJogo,obj.oddsA,obj.oddsB], callback)
    },
